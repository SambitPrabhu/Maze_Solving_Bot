...
def isAccessible(x,y,x1,y1):
    ...
    if (x==x1):
        if(y>y1):
            if(maze[z][x]==4 or maze[z][x]==5 or maze[z][x]==6 or maze[z][x]==10 or maze[z][x]==11 or maze[z][x]==12 or maze[z][x]==14 ):
                return (False)
            else:
                return(True)
        else:
            if(maze[z][x]==2 or maze[z][x]==7 or maze[z][x]==8 or maze[z][x]==10 or maze[z][x]==12 or maze[z][x]==13 or maze[z][x]==14 ):
                return (False)
            else:
                return(True)
        ...
        if(x>x1):
            if(maze[z][x]==1 or maze[z][x]==5 or maze[z][x]==8 or maze[z][x]==9 or maze[z][x]==11 or maze[z][x]==13 or maze[z][x]==14 ):
                return (False)
            else:
                return (True)
        else:
            if(maze[z][x]==3 or maze[z][x]==6 or maze[z][x]==7 or maze[z][x]==9 or maze[z][x]==11 or maze[z][x]==12 or maze[z][x]==13 ):
                return (False)
            else:
                return (True)
...
def isChannel(x,y):
    print("checks bot is in channel")
    global maze 
...
def toMove(x,y,xprev,yprev,orient):
    ...
    '''
    print("x prev and y prev ",xprev,yprev)
    global flood
...
def wallFront():
    ...
    print("forward wall distance ",wall_dist)
    return (wall_dist<1.3*G)
...
def main():
    ...
    y=15 #Stores the location of y coordinate currently robot is at.
    ...
    while not rospy.is_shutdown():
        ...
        print(flood[y][x],"flood value")


        if (flood[y][x]!=0):  #bot is not in center
            print("bot is not in center")
            if flag == 0:
                print("enter stable position and flag==0")
                if(flag3==0):
                    print("enter flag 3")
                    if(maze[y][x]==0):
                        L= wallLeft()
                        R= wallRight()
                        F= wallFront()
                        print("walls orientation is ",L,F,R)
                        updateWalls(x,y,orient,L,R,F)
                        print(maze)
