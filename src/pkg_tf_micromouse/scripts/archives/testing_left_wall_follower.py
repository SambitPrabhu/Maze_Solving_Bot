...
wall_dist = 0.065           # Distance desired from the wall
...
def clbk_laser(msg):
    ...
    # if(bool_inner_corner==1):
    #     rotating=1
    #     print("inner corner detected")
...
def take_action():
    ...
    global wall_dist, max_speed, direction, p, d, angle, dist_min, wall_found, rotating, bool_outer_corner, bool_inner_corner,state_
    ...
    #     change_state(2)
    elif  regions['fright'] < wall_dist and regions['front'] < wall_dist and regions['fleft'] < wall_dist:
        print("inner corner detected successfully")
        # change_state(2)
        state_=2
    else:
...
#             last_outer_corner_d 0.25etection_time = time.time()
...
def main():
    global pub_, active_, hz, loop_index,state_
    ...
    while not rospy.is_shutdown():
        ...
        if state_ == 0:
            ...
            print('Unknown state!')
        # print("angular velocity is ",msg.linear.z)
        pub_.publish(msg)
