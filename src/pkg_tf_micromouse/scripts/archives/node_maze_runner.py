...
def clbk_laser(msg):
    ...
    # 720 / 5 = 144
    regions = [
        round(100*min(min(msg.ranges[0:71]), 2)),
        round(100*min(min(msg.ranges[72:143]), 2)),
        round(100*min(min(msg.ranges[144:215]), 2)),
        round(100*min(min(msg.ranges[216:287]), 2)),
        round(100*min(min(msg.ranges[288:359]), 2)),
    ]
