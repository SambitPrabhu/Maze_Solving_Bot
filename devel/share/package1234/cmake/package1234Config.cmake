...
if(NOT "/home/shikhar/techfest_ws/devel/include " STREQUAL " ")
  set(package1234_INCLUDE_DIRS "")
  set(_include_dirs "/home/shikhar/techfest_ws/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'package1234' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/shikhar/techfest_ws/src/package1234/${idir}'.  ${_report}")
    endif()
